...
public class ArcProgressBar extends View {
     ...
     * 圆弧颜色
     */
    private int mArcBgColor = 0xFFFFE100;
    /**
     * 虚线默认颜色
     */
     ...
     * 虚线变动颜色
     */
    private int mDottedRunColor = 0xFFFFE100;
    /**
     * 圆弧两边的距离
     */
   ...
   private String mArcText= "";
     ...
     * 线条宽度
     */
    private int mDottedLineWidth = 30;
    /**
     * 线条高度
     */
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mRountRect.left = (float) (2 * mArcCenterX - 2 * aDistance) / 2 - mArcWidth / 2 + 60;
        mRountRect.top = (float) (mArcCenterX + bDistance) - 10;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRoundRect(mRountRect, 120, 100, mRonudRectPaint);
