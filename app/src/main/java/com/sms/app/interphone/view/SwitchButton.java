...
public class SwitchButton extends View implements View.OnClickListener {
    ...
    private void init(@Nullable AttributeSet attrs) {
        ...
        padding = a.getDimension(R.styleable.SwitchView_padding, dp2px(2));
    ...
    //    LogUtil.i(GlobalConsts.TAG,"initPath:"+mWidth+",padding:"+padding);
    ...
    private void initAnim() {
        ...
        //    LogUtil.i(GlobalConsts.TAG,"setChecked:+mClickWidth:"+mClickWidth+",mWidth:"+mWidth+",padding:"+padding);
    ...
    //    LogUtil.i(GlobalConsts.TAG,"onMeasure:");
    ...
    public void setChecked(int i, boolean checked) {
        if (checked != this.checked) {
         ...
         //   LogUtil.i(GlobalConsts.TAG,"setChecked:"+checked);
    ...
    public void setOnClickCheckedListener(SwitchButton.onClickCheckedListener onClickCheckedListener) {
