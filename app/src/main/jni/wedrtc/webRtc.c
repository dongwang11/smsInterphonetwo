...
void WebRtcAgcTest(char *filename, char *outfilename,int fs)
{
	...
	do
	{
		...
		{
			memset(pData, 0, len);
			//printf("pData :%#x, infp :%#x \r\n", pData, infp);
			len = fread(pData, 1, len, infp);
			//len = fread(pData, sizeof(short), len, infp);
			if (len > 0)
			{
...
//	WebRtcAgcTest("C:\\Users\\Administrator\\workspace\\webRtc\\src\\byby_8K_1C_16bit.pcm","byby_8K_1C_16bit_agc.pcm",8000);
//	NoiseSuppression32("C:\\Users\\Administrator\\workspace\\webRtc\\src\\lhydd_1C_16bit_32K.PCM","lhydd_1C_16bit_32K_ns.pcm",32000,1);
	//NoiseSuppressionX32("C:\\Users\\Administrator\\workspace\\webRtc\\src\\lhydd_1C_16bit_32K.PCM","lhydd_1C_16bit_32K_nsx.pcm",32000,1);
