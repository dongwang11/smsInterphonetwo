...
public class ChatListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private void init(Context context) {
        try {
            setCacheColorHint(context.getResources().getColor(R.color.chat_listview_background));
            inflater = LayoutInflater.from(context);
            headerView = (LinearLayout) inflater.inflate(R.layout.chat_listview_header, null);
        ...
        try {
            switch (state) {
                ...
                case DONE:
                    ...
                    lvHeaderProgressBar.setVisibility(View.GONE);
                    lvHeaderArrowIv.clearAnimation();
                    lvHeaderArrowIv.setImageResource(R.mipmap.pull_to_refresh_arrow);
                    lvHeaderTipsTv.setText("下拉刷新");
                    lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
                    break;
            }
